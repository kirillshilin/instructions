...
| T-I02 | `shai-typescript-testing`          | instruction | `**/*.spec.ts`           | Should   | 🟢      | Test file structure, file-level describe blocks, explicit API coverage, and case-based test patterns                        | "Root describe uses source file name; nested describes cover each public/exported API" |
